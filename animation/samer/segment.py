...
import cv2
import numpy as np
from animation.samer.segmentor import Segmentor
from animation.samer.transfer_tools import draw_outline, draw_points
from animation.samer.seg_anything import draw_mask
